    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('operarios.register') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Lora Electricidad" required autocomplete="name" autofocus >
                        ...
                        <div class="row mb-3">
                            <label for="tipe" class="col-md-4 col-form-label text-md-end">Tipo de empresa</label>
                            <div class="col-md-6">
