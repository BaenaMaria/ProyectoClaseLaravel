                        ...
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">Usuario: {{$ticket->idUser}}</li>
                                    <li class="list-group-item">Estado: {{$ticket->status}}</li>
                                    <li class="list-group-item">Fecha de inicio: {{$ticket->dateIni}}</li>
                                    <li class="list-group-item">Fecha fin:{{$ticket->dateEnd}}</li>

                                </ul>

                                @if(Auth::user()->role=='administrador'||Auth::user()->tipe==$ticket->tipe)
